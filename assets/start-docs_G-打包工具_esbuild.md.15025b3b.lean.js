...
<span class="line"><span style="color:#F8F8F2;">    }</span></span>
<span class="line"><span style="color:#F8F8F2;">}).</span><span style="color:#A6E22E;">catch</span><span style="color:#F8F8F2;">(() </span><span style="color:#66D9EF;font-style:italic;">=&gt;</span><span style="color:#F8F8F2;"> process.</span><span style="color:#A6E22E;">exit</span><span style="color:#F8F8F2;">(</span><span style="color:#AE81FF;">1</span><span style="color:#F8F8F2;">));</span></span></code></pre><button class="link">将此代码在线运行</button></div><h2 id="详细配置项" tabindex="-1">详细配置项 <a class="header-anchor" href="#详细配置项" aria-label="Permalink to &quot;详细配置项&quot;">​</a></h2><h3 id="_1-基础选项" tabindex="-1">1. 基础选项 <a class="header-anchor" href="#_1-基础选项" aria-label="Permalink to &quot;1. 基础选项&quot;">​</a></h3><div class="language-js codearea-link" id="pdjuhab2y2"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h3 id="_2-构建选项" tabindex="-1">2. 构建选项 <a class="header-anchor" href="#_2-构建选项" aria-label="Permalink to &quot;2. 构建选项&quot;">​</a></h3><div class="language-js codearea-link" id="v2z9fodu4if"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h3 id="_3-依赖处理" tabindex="-1">3. 依赖处理 <a class="header-anchor" href="#_3-依赖处理" aria-label="Permalink to &quot;3. 依赖处理&quot;">​</a></h3><div class="language-js codearea-link" id="9lksrxx4ck"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h3 id="_4-加载器配置" tabindex="-1">4. 加载器配置 <a class="header-anchor" href="#_4-加载器配置" aria-label="Permalink to &quot;4. 加载器配置&quot;">​</a></h3><div class="language-js codearea-link" id="srjsyk796o9"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">    }</span></span>
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h3 id="_5-优化选项" tabindex="-1">5. 优化选项 <a class="header-anchor" href="#_5-优化选项" aria-label="Permalink to &quot;5. 优化选项&quot;">​</a></h3><div class="language-js codearea-link" id="89wplmg1vpq"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h2 id="常用插件配置" tabindex="-1">常用插件配置 <a class="header-anchor" href="#常用插件配置" aria-label="Permalink to &quot;常用插件配置&quot;">​</a></h2><div class="language-js codearea-link" id="351stn5t4t6"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#66D9EF;font-style:italic;">const</span><span style="color:#F8F8F2;"> esbuild </span><span style="color:#F92672;">=</span><span style="color:#F8F8F2;"> </span><span style="color:#A6E22E;">require</span><span style="color:#F8F8F2;">(</span><span style="color:#E6DB74;">&#39;esbuild&#39;</span><span style="color:#F8F8F2;">);</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F8F8F2;">esbuild.</span><span style="color:#A6E22E;">build</span><span style="color:#F8F8F2;">({</span></span>
...
<span class="line"><span style="color:#F8F8F2;">        }</span></span>
<span class="line"><span style="color:#F8F8F2;">    ]</span></span>
<span class="line"><span style="color:#F8F8F2;">}).</span><span style="color:#A6E22E;">catch</span><span style="color:#F8F8F2;">(() </span><span style="color:#66D9EF;font-style:italic;">=&gt;</span><span style="color:#F8F8F2;"> process.</span><span style="color:#A6E22E;">exit</span><span style="color:#F8F8F2;">(</span><span style="color:#AE81FF;">1</span><span style="color:#F8F8F2;">));</span></span></code></pre><button class="link">将此代码在线运行</button></div><h2 id="性能优化建议" tabindex="-1">性能优化建议 <a class="header-anchor" href="#性能优化建议" aria-label="Permalink to &quot;性能优化建议&quot;">​</a></h2><ol><li><strong>合理使用 external</strong></li></ol><div class="language-js codearea-link" id="vuvmsasr8jf"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">    ]</span></span>
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><ol start="2"><li><strong>开发环境配置</strong></li></ol><div class="language-js codearea-link" id="afvlkw3huku"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><ol start="3"><li><strong>生产环境配置</strong></li></ol><div class="language-js codearea-link" id="9w9x5xhpk9"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
...
<span class="line"><span style="color:#F8F8F2;">    ]</span></span>
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h3 id="_2-处理图片和资源" tabindex="-1">2. 处理图片和资源 <a class="header-anchor" href="#_2-处理图片和资源" aria-label="Permalink to &quot;2. 处理图片和资源&quot;">​</a></h3><div class="language-js codearea-link" id="yew68caja8p"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
<span class="line"><span style="color:#F8F8F2;">    loader: {</span></span>
<span class="line"><span style="color:#F8F8F2;">        </span><span style="color:#E6DB74;">&#39;.png&#39;</span><span style="color:#F8F8F2;">: </span><span style="color:#E6DB74;">&#39;file&#39;</span><span style="color:#F8F8F2;">,</span></span>
...
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div><h3 id="_3-环境变量处理" tabindex="-1">3. 环境变量处理 <a class="header-anchor" href="#_3-环境变量处理" aria-label="Permalink to &quot;3. 环境变量处理&quot;">​</a></h3><div class="language-js codearea-link" id="1mx734crw3n"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai"><code><span class="line"><span style="color:#F8F8F2;">{</span></span>
<span class="line"><span style="color:#F8F8F2;">    define: {</span></span>
<span class="line"><span style="color:#F8F8F2;">        </span><span style="color:#E6DB74;">&#39;p<wbr>rocess.env.NODE_ENV&#39;</span><span style="color:#F8F8F2;">: </span><span style="color:#E6DB74;">&#39;&quot;production&quot;&#39;</span><span style="color:#F8F8F2;">,</span></span>
...
<span class="line"><span style="color:#F8F8F2;">    }</span></span>
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre><button class="link">将此代码在线运行</button></div>`,36)]))}const u=n(o,[["render",e]]);export{d as __pageData,u as default};
