import{_ as n,r as e,i as a,a as l}from"./chunks/framework.bb8f9838.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"柯里化 currying","slug":"柯里化-currying","link":"#柯里化-currying","children":[]}],"relativePath":"start-docs/B-JS/柯里化.md","filePath":"start-docs/B-JS/柯里化.md"}'),p={name:"start-docs/B-JS/柯里化.md"};function t(c,s,o,r,i,y){return e(),a("div",null,s[0]||(s[0]=[l(`<h2 id="柯里化-currying" tabindex="-1">柯里化 currying <a class="header-anchor" href="#柯里化-currying" aria-label="Permalink to &quot;柯里化 currying&quot;">​</a></h2><ul><li><p>在数学和计算机科学中，柯里化是一种将使用多个参数的一个函数转换成一系列使用一个参数的函数的技术。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark"><code><span class="line"><span style="color:#e1e4e8;">function add(a, b) {</span></span>
