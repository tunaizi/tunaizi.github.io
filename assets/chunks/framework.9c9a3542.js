...
let nh = Symbol("_vte"), ng = (e7) => e7.__isTeleport, nv = (e7) => e7 && (e7.disabled || "" === e7.disabled), nm = (e7) => e7 && (e7.defer || "" === e7.defer), n_ = (e7) => "undefined" != typeof SVGElement && e7 instanceof SVGElement, ny = (e7) => "function" == typeof MathMLElement && e7 instanceof MathMLElement, nb = (e7, t10) => {
  let n2 = e7 && e7.to;
  return P(n2) ? t10 ? t10(n2) : null : n2;
}, nS = { name: "Teleport", __isTeleport: true, process(e7, t10, n2, l10, r10, i10, s4, o2, a2, u2) {
  let { mc: c, pc: f2, pbc: p2, o: { insert: d2, querySelector: h2, createText: g2, createComment: m2 } } = u2, _2 = nv(t10.props), { shapeFlag: y2, children: b2, dynamicChildren: S2 } = t10;
  if (null == e7) {
    let e10 = t10.el = g2(""), u3 = t10.anchor = g2("");
    d2(e10, n2, l10), d2(u3, n2, l10);
    let f3 = (e11, t11) => {
      16 & y2 && (r10 && r10.isCE && (r10.ce._teleportTarget = e11), c(b2, e11, t11, r10, i10, s4, o2, a2));
    }, p3 = () => {
      let e11 = t10.target = nb(t10.props, h2), n3 = nw(e11, t10, g2, d2);
      e11 && ("svg" !== s4 && n_(e11) ? s4 = "svg" : "mathml" !== s4 && ny(e11) && (s4 = "mathml"), _2 || (f3(e11, n3), nE(t10, false)));
    };
    _2 && (f3(n2, u3), nE(t10, true)), nm(t10.props) ? ry(() => {
      p3(), t10.el.__isMounted = true;
    }, i10) : p3();
  } else {
    if (nm(t10.props) && !e7.el.__isMounted) {
      ry(() => {
        nS.process(e7, t10, n2, l10, r10, i10, s4, o2, a2, u2), delete e7.el.__isMounted;
      }, i10);
      return;
    }
    t10.el = e7.el, t10.targetStart = e7.targetStart;
    let c2 = t10.anchor = e7.anchor, d3 = t10.target = e7.target, g3 = t10.targetAnchor = e7.targetAnchor, m3 = nv(e7.props), y3 = m3 ? n2 : d3;
    if ("svg" === s4 || n_(d3) ? s4 = "svg" : ("mathml" === s4 || ny(d3)) && (s4 = "mathml"), S2 ? (p2(e7.dynamicChildren, S2, y3, r10, i10, s4, o2), rk(e7, t10, true)) : a2 || f2(e7, t10, y3, m3 ? c2 : g3, r10, i10, s4, o2, false), _2)
      m3 ? t10.props && e7.props && t10.props.to !== e7.props.to && (t10.props.to = e7.props.to) : nC(t10, n2, c2, u2, 1);
    else if ((t10.props && t10.props.to) !== (e7.props && e7.props.to)) {
      let e10 = t10.target = nb(t10.props, h2);
      e10 && nC(t10, e10, null, u2, 0);
    } else
      m3 && nC(t10, d3, g3, u2, 1);
    nE(t10, _2);
  }
}, remove(e7, t10, n2, { um: l10, o: { remove: r10 } }, i10) {
  let { shapeFlag: s4, children: o2, anchor: a2, targetStart: u2, targetAnchor: c, target: f2, props: p2 } = e7;
  if (f2 && (r10(u2), r10(c)), i10 && r10(a2), 16 & s4) {
    let e10 = i10 || !nv(p2);
    for (let r11 = 0; r11 < o2.length; r11++) {
      let i11 = o2[r11];
      l10(i11, t10, n2, e10, !!i11.dynamicChildren);
    }
  }
}, move: nC, hydrate: function(e7, t10, n2, l10, r10, i10, { o: { nextSibling: s4, parentNode: o2, querySelector: a2, insert: u2, createText: c } }, f2) {
  let p2 = t10.target = nb(t10.props, a2);
  if (p2) {
    let a3 = nv(t10.props), d2 = p2._lpa || p2.firstChild;
    if (16 & t10.shapeFlag) {
      if (a3)
        t10.anchor = f2(s4(e7), t10, o2(e7), n2, l10, r10, i10), t10.targetStart = d2, t10.targetAnchor = d2 && s4(d2);
      else {
        t10.anchor = s4(e7);
        let o3 = d2;
        for (; o3; ) {
          if (o3 && 8 === o3.nodeType) {
            if ("teleport start anchor" === o3.data)
              t10.targetStart = o3;
            else if ("teleport anchor" === o3.data) {
              t10.targetAnchor = o3, p2._lpa = t10.targetAnchor && s4(t10.targetAnchor);
              break;
            }
          }
          o3 = s4(o3);
        }
        t10.targetAnchor || nw(p2, t10, c, u2), f2(d2 && s4(d2), t10, p2, n2, l10, r10, i10);
      }
    }
    nE(t10, a3);
  }
  return t10.anchor && s4(t10.anchor);
} };
function nC(e7, t10, n2, { o: { insert: l10 }, m: r10 }, i10 = 2) {
  0 === i10 && l10(e7.targetAnchor, t10, n2);
  let { el: s4, anchor: o2, shapeFlag: a2, children: u2, props: c } = e7, f2 = 2 === i10;
  if (f2 && l10(s4, t10, n2), (!f2 || nv(c)) && 16 & a2)
    for (let e10 = 0; e10 < u2.length; e10++)
      r10(u2[e10], t10, n2, 2);
  f2 && l10(o2, t10, n2);
}
let nx = nS;
function nE(e7, t10) {
  ...
  if (n2 && n2.ut) {
    let l10, r10;
    for (t10 ? (l10 = e7.el, r10 = e7.anchor) : (l10 = e7.targetStart, r10 = e7.targetAnchor); l10 && l10 !== r10; )
      1 === l10.nodeType && l10.setAttribute("data-v-owner", n2.uid), l10 = l10.nextSibling;
    n2.ut();
  }
}
function nw(e7, t10, n2, l10) {
  let r10 = t10.targetStart = n2(""), i10 = t10.targetAnchor = n2("");
  return r10[nh] = i10, e7 && (l10(r10, e7), l10(i10, e7)), i10;
}
...
function lA(e7, t10) {
  for (let n2 = 0; n2 < t10.length; n2++) {
    let l10 = t10[n2];
    if (k(l10))
      for (let t11 = 0; t11 < l10.length; t11++)
        e7[l10[t11].name] = l10[t11].fn;
    else
      l10 && (e7[l10.name] = l10.key ? (...e10) => {
        let t11 = l10.fn(...e10);
        return t11 && (t11.key = l10.key), t11;
      } : l10.fn);
  }
  return e7;
}
