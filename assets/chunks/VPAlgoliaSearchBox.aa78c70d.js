import { n as nj, I as useRoute, J as useRouter, l as lf, r as r3, i as it$1 } from "./framework.e6716b1e.js";
import { u as useConfig } from "../app.1e43e4e9.js";
import "./index.539c2a0b.js";
import "./sponsors.66242e06.js";
...
function I(e2, t2, n2, r2, o2, i2, a2, c2, u2, l2, s2) {
  ...
  for (n2.__d = u2, function(e3, t3, n3) {
    var r4, o3, i3, a3, c3, u3 = t3.length, l3 = n3.length, s3 = l3, f3 = 0;
    for (e3.__k = [], r4 = 0; r4 < u3; r4++)
      null != (o3 = t3[r4]) && "boolean" != typeof o3 && "function" != typeof o3 ? (a3 = r4 + f3, (o3 = e3.__k[r4] = "string" == typeof o3 || "number" == typeof o3 || "bigint" == typeof o3 || o3.constructor == String ? b(null, o3, null, null, null) : d(o3) ? b(S, { children: o3 }, null, null, null) : void 0 === o3.constructor && o3.__b > 0 ? b(o3.type, o3.props, o3.key, o3.ref ? o3.ref : null, o3.__v) : o3).__ = e3, o3.__b = e3.__b + 1, i3 = null, -1 !== (c3 = o3.__i = C(o3, n3, a3, s3)) && (s3--, (i3 = n3[c3]) && (i3.__u |= 131072)), null == i3 || null === i3.__v ? (-1 == c3 && f3--, "function" != typeof o3.type && (o3.__u |= 65536)) : c3 !== a3 && (c3 == a3 - 1 ? f3-- : c3 == a3 + 1 ? f3++ : (c3 > a3 ? f3-- : f3++, o3.__u |= 65536))) : o3 = e3.__k[r4] = null;
    if (s3)
      for (r4 = 0; r4 < l3; r4++)
        null != (i3 = n3[r4]) && !(131072 & i3.__u) && (i3.__e == e3.__d && (e3.__d = w(i3)), M(i3, i3));
...
var ut = { useState: re, useId: me, useReducer: oe, useEffect: ie, useLayoutEffect: ae, useInsertionEffect: it, useTransition: ot, useDeferredValue: rt, useSyncExternalStore: at, startTransition: nt, useRef: ce, useImperativeHandle: ue, useMemo: le, useCallback: se, useContext: fe, useDebugValue: pe, version: "18.3.1", Children: Pe, render: Ke, hydrate: function(e2, t2, n2) {
  ...
  function n2(e3) {
    var n3 = this.props.ref, r4 = n3 == e3.ref;
    return !r4 && n3 && (n3.call ? n3(null) : n3.current = null), t2 ? !t2(this.props, e3) || !r4 : Se(this.props, e3);
  }
  function r2(t3) {
...
function wt() {
  ...
  function f2(e3, t2, n3, r4) {
    var o3 = t2 && t2.prototype instanceof _2 ? t2 : _2, a3 = Object.create(o3.prototype), c3 = new x2(r4 || []);
  ...
  function I2(t2, n3, r4) {
    ...
    return function(i3, a3) {
      ...
      for (r4.method = i3, r4.arg = a3; ; ) {
        ...
        var l3 = p2(t2, n3, r4);
        if ("normal" === l3.type) {
          if (o3 = r4.done ? d2 : v2, l3.arg === y2)
            continue;
          return { value: l3.arg, done: r4.done };
        }
        "throw" === l3.type && (o3 = d2, r4.method = "throw", r4.arg = l3.arg);
      }
    };
  }
  function k2(t2, n3) {
    var r4 = n3.method, o3 = t2.iterator[r4];
    if (o3 === e2)
      return n3.delegate = null, "throw" === r4 && t2.iterator.return && (n3.method = "return", n3.arg = e2, k2(t2, n3), "throw" === n3.method) || "return" !== r4 && (n3.method = "throw", n3.arg = new TypeError("The iterator does not provide a '" + r4 + "' method")), y2;
  ...
  return g2.prototype = b2, i2(E2, "constructor", { value: b2, configurable: true }), i2(b2, "constructor", { value: g2, configurable: true }), g2.displayName = s2(b2, l2, "GeneratorFunction"), n2.isGeneratorFunction = function(e3) {
    ...
    return this;
  }), n2.AsyncIterator = P2, n2.async = function(e3, t2, r4, o3, i3) {
    void 0 === i3 && (i3 = Promise);
    var a3 = new P2(f2(e3, t2, r4, o3), i3);
    ...
    return n3.reverse(), function e4() {
      for (; n3.length; ) {
        var r5 = n3.pop();
        if (r5 in t2)
          return e4.value = r5, e4.done = false, e4;
      }
    ...
    var n3 = this;
    function r4(r5, o3) {
      return c3.type = "throw", c3.arg = t2, n3.next = r5, o3 && (n3.method = "next", n3.arg = e2), !!o3;
    }
      ...
      if (a3.tryLoc <= this.prev) {
        ...
        if (u3 && l3) {
          if (this.prev < a3.catchLoc)
            return r4(a3.catchLoc, true);
          if (this.prev < a3.finallyLoc)
            return r4(a3.finallyLoc);
        } else if (u3) {
          if (this.prev < a3.catchLoc)
            return r4(a3.catchLoc, true);
        } else {
    ...
    for (var n3 = this.tryEntries.length - 1; n3 >= 0; --n3) {
      var r4 = this.tryEntries[n3];
      if (r4.tryLoc <= this.prev && o2.call(r4, "finallyLoc") && this.prev < r4.finallyLoc) {
        var i3 = r4;
        break;
      }
    }
  ...
  }, delegateYield: function(t2, n3, r4) {
    return this.delegate = { iterator: A2(t2), resultName: n3, nextLoc: r4 }, "next" === this.method && (this.arg = e2), y2;
  } }, n2;
}
function Et(e2, t2) {
...
function Zt(e2, t2) {
  ...
  var n2, r2, o2 = function(e3, t3) {
    if (null == e3)
      return {};
    var n3, r4, o3 = {}, i3 = Object.keys(e3);
    for (r4 = 0; r4 < i3.length; r4++)
      n3 = i3[r4], t3.indexOf(n3) >= 0 || (o3[n3] = e3[n3]);
    return o3;
  }(e2, t2);
  if (Object.getOwnPropertySymbols) {
    var i2 = Object.getOwnPropertySymbols(e2);
...
function mn(e2) {
  var t2 = function(e3) {
    return un({ onItemsChange: function(e4) {
      var t3 = e4.insights, n3 = e4.insightsEvents, r4 = e4.state;
      t3.viewedObjectIDs.apply(t3, on(n3.map(function(e5) {
        return un(un({}, e5), {}, { algoliaSource: vn(e5.algoliaSource, r4.context) });
      })));
  ...
  if (n2 || "undefined" != typeof window && function() {
    ...
    "string" == typeof t3 && (u2 = e3[t3]), u2 || (e3.AlgoliaAnalyticsObject = t3, e3[t3] || (e3[t3] = function() {
      ...
      for (var n3 = arguments.length, r4 = new Array(n3), o3 = 0; o3 < n3; o3++)
        r4[o3] = arguments[o3];
      e3[t3].queue.push(r4);
  ...
  var l2 = function(e3) {
    var t3, n3, r4, o3 = (t3 = function(e4) {
      return function(e5) {
        if (Array.isArray(e5))
          return e5;
      }(e4) || function(e5) {
        ...
        if (null != t4) {
          var n4, r5, o4, i4, a3 = [], c3 = true, u3 = false;
          try {
    ...
    }((e3.version || "").split(".").map(Number)), n3 = t3[0], r4 = t3[1], n3 >= 3 || 2 === n3 && r4 >= 4 || 1 === n3 && r4 >= 10);
    function i3(t4, n4, r5) {
      if (o3 && void 0 !== r5) {
        var i4 = r5[0].__autocomplete_algoliaCredentials, a3 = { "X-Algolia-Application-Id": i4.appId, "X-Algolia-API-Key": i4.apiKey };
    ...
    return { init: function(t4, n4) {
      ...
      for (var t4 = arguments.length, n4 = new Array(t4), r5 = 0; r5 < t4; r5++)
        n4[r5] = arguments[r5];
      ...
      t4.length > 0 && t4.reduce(function(e5, t5) {
        var n5 = t5.items, r5 = Zt(t5, zt);
        return [].concat(Qt(e5), Qt(function(e6) {
          for (var t6 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 20, n6 = [], r6 = 0; r6 < e6.objectIDs.length; r6 += t6)
            n6.push(Yt(Yt({}, e6), {}, { objectIDs: e6.objectIDs.slice(r6, r6 + t6) }));
          return n6;
        }(Yt(Yt({}, r5), {}, { objectIDs: (null == n5 ? void 0 : n5.map(function(e6) {
          return e6.objectID;
        })) || r5.objectIDs })).map(function(e6) {
  ...
  return { name: "aa.algoliaInsightsPlugin", subscribe: function(e3) {
    var t3 = e3.setContext, n3 = e3.onSelect, r4 = e3.onActive, o3 = false;
    function s3(e4) {
    ...
    u2("addAlgoliaAgent", "insights-plugin"), s3(), u2("onUserTokenChange", function(e4) {
      ...
      var t4 = e4.item, n4 = e4.state, r5 = e4.event, o4 = e4.source;
      nn(t4) && i2({ state: n4, event: r5, insights: l2, item: t4, insightsEvents: [un({ eventName: "Item Selected" }, Vt({ item: t4, items: o4.getItems().filter(nn) }))] });
    }), r4(function(e4) {
      var t4 = e4.item, n4 = e4.source, r5 = e4.state, o4 = e4.event;
      nn(t4) && a2({ state: r5, event: o4, insights: l2, item: t4, insightsEvents: [un({ eventName: "Item Active" }, Vt({ item: t4, items: n4.getItems().filter(nn) }))] });
    });
...
function En(e2) {
  ...
  var n2 = t2.items[function(e3) {
    for (var t3 = e3.state, n3 = e3.collection, r4 = false, o2 = 0, i2 = 0; false === r4; ) {
...
function ur(e2) {
  var t2 = e2.event, n2 = e2.nextState, r2 = void 0 === n2 ? {} : n2, o2 = e2.props, i2 = e2.query, a2 = e2.refresh, c2 = e2.store, u2 = function(e3, t3) {
    if (null == e3)
      return {};
    var n3, r4, o3 = function(e4, t4) {
      if (null == e4)
        return {};
      var n4, r5, o4 = {}, i4 = Object.keys(e4);
      for (r5 = 0; r5 < i4.length; r5++)
        n4 = i4[r5], t4.indexOf(n4) >= 0 || (o4[n4] = e4[n4]);
      return o4;
    }(e3, t3);
    if (Object.getOwnPropertySymbols) {
      var i3 = Object.getOwnPropertySymbols(e3);
      for (r4 = 0; r4 < i3.length; r4++)
        n3 = i3[r4], t3.indexOf(n3) >= 0 || Object.prototype.propertyIsEnumerable.call(e3, n3) && (o3[n3] = e3[n3]);
    }
    return o3;
  }(e2, Xn);
  ...
  var _2 = yn(cr(o2.getSources(tr({ query: i2, refresh: a2, state: c2.getState() }, u2)).then(function(e3) {
    return Promise.all(e3.map(function(e4) {
      return Promise.resolve(e4.getItems(tr({ query: i2, refresh: a2, state: c2.getState() }, u2))).then(function(t3) {
        return function(e5, t4, n3) {
          if (o3 = e5, Boolean(null == o3 ? void 0 : o3.execute)) {
            var r4 = "algolia" === e5.requesterId ? Object.assign.apply(Object, [{}].concat(Qn(Object.keys(n3.context).map(function(e6) {
              var t5;
            ...
            return zn(zn({}, e5), {}, { requests: e5.queries.map(function(n4) {
              return { query: "algolia" === e5.requesterId ? zn(zn({}, n4), {}, { params: zn(zn({}, r4), n4.params) }) : n4, sourceId: t4, transformResponse: e5.transformResponse };
            }) });
          }
          var o3;
      ...
      var n3, r4 = t3.some(function(e4) {
        return function(e5) {
          return !Array.isArray(e5) && Boolean(null == e5 ? void 0 : e5._automaticInsights);
        }(e4.items);
      });
      return r4 && v2({ algoliaInsightsPlugin: tr(tr({}, (null === (n3 = c2.getState().context) || void 0 === n3 ? void 0 : n3.algoliaInsightsPlugin) || {}), {}, { __automaticInsights: r4 }) }), function(e4, t4, n4) {
        return t4.map(function(t5) {
          var r5, o3 = e4.filter(function(e5) {
            return e5.sourceId === t5.sourceId;
          }), i3 = o3.map(function(e5) {
            return e5.items;
          }), a3 = o3[0].transformResponse, c3 = a3 ? a3({ results: r5 = i3, hits: r5.map(function(e5) {
            return e5.hits;
          }).filter(Boolean), facetHits: r5.map(function(e5) {
            var t6;
      ...
      return function(e5) {
        var t3 = e5.props, n3 = e5.state, r4 = e5.collections.reduce(function(e6, t4) {
        ...
        }, { sourcesBySourceId: r4, state: n3 }).sourcesBySourceId;
...
function Ur(e2) {
  var t2 = [], n2 = function(e3, t3) {
    var n3, r4 = "undefined" != typeof window ? window : {}, o3 = e3.plugins || [];
    return Mn(Mn({ debug: false, openOnFocus: false, enterKeyHint: void 0, ignoreCompositionEvents: false, placeholder: "", autoFocus: false, defaultActiveItemId: null, stallThreshold: 300, insights: void 0, environment: r4, shouldPanelOpen: function(e4) {
      ...
      var t4 = e4.itemUrl;
      r4.location.assign(t4);
    }, navigateNewTab: function(e4) {
      var t4 = e4.itemUrl, n4 = r4.open(t4, "_blank", "noopener");
      null == n4 || n4.focus();
    }, navigateNewWindow: function(e4) {
      var t4 = e4.itemUrl;
      r4.open(t4, "_blank", "noopener");
    } }, e3.navigator) });
  }(e2, t2), r2 = function(e3, t3, n3) {
    var r4, o3 = t3.initialState;
    return { getState: function() {
      return o3;
    }, dispatch: function(r5, i3) {
      var a3 = function(e4) {
      ...
      o3 = e3(o3, { type: r5, props: t3, payload: i3 }), n3({ state: o3, prevState: a3 });
    }, pendingRequests: (r4 = [], { add: function(e4) {
      return r4.push(e4), e4.finally(function() {
        r4 = r4.filter(function(t4) {
          return t4 !== e4;
        });
      });
    }, cancelAll: function() {
    ...
    var t3, r4, i3 = e3.prevState, l3 = e3.state;
    if (n2.onStateChange(Mr({ prevState: i3, state: l3, refresh: a2, navigator: n2.navigator }, o2)), !u2() && null !== (t3 = l3.context) && void 0 !== t3 && null !== (r4 = t3.algoliaInsightsPlugin) && void 0 !== r4 && r4.__automaticInsights && false !== n2.insights) {
    ...
    var t3 = e3.props, n3 = e3.refresh, r4 = e3.store, o3 = Er(e3, hr);
    return { getEnvironmentProps: function(e4) {
      var n4 = e4.inputElement, o4 = e4.formElement, i3 = e4.panelElement;
      function a3(e5) {
        !r4.getState().isOpen && r4.pendingRequests.isEmpty() || e5.target === n4 || false === [o4, i3].some(function(t4) {
          return (n5 = t4) === (r5 = e5.target) || n5.contains(r5);
          var n5, r5;
        }) && (r4.dispatch("blur", null), t3.debug || r4.pendingRequests.cancelAll());
      }
      return Or({ onTouchStart: a3, onMouseDown: a3, onTouchMove: function(e5) {
        false !== r4.getState().isOpen && n4 === t3.environment.document.activeElement && e5.target !== n4 && n4.blur();
      } }, Er(e4, dr));
    }, getRootProps: function(e4) {
      return Or({ role: "combobox", "aria-expanded": r4.getState().isOpen, "aria-haspopup": "listbox", "aria-controls": r4.getState().isOpen ? r4.getState().collections.map(function(e5) {
        var n4 = e5.source;
      ...
      return e4.inputElement, Or({ action: "", noValidate: true, role: "search", onSubmit: function(i3) {
        var a3;
        i3.preventDefault(), t3.onSubmit(Or({ event: i3, refresh: n3, state: r4.getState() }, o3)), r4.dispatch("submit", null), null === (a3 = e4.inputElement) || void 0 === a3 || a3.blur();
      }, onReset: function(i3) {
        var a3;
        i3.preventDefault(), t3.onReset(Or({ event: i3, refresh: n3, state: r4.getState() }, o3)), r4.dispatch("reset", null), null === (a3 = e4.inputElement) || void 0 === a3 || a3.focus();
      } }, Er(e4, yr));
      ...
      var i3;
      function a3(e5) {
        (t3.openOnFocus || Boolean(r4.getState().query)) && ur(Or({ event: e5, props: t3, query: r4.getState().completion || r4.getState().query, refresh: n3, store: r4 }, o3)), r4.dispatch("focus", null);
      }
      var c3 = e4 || {};
      c3.inputElement;
      var u3 = c3.maxLength, l3 = void 0 === u3 ? 512 : u3, s2 = Er(c3, _r), f2 = En(r4.getState()), p2 = function(e5) {
      ...
      return Or({ "aria-autocomplete": "both", "aria-activedescendant": r4.getState().isOpen && null !== r4.getState().activeItemId ? jn(t3.id, "item-".concat(r4.getState().activeItemId), null == f2 ? void 0 : f2.source) : void 0, "aria-controls": r4.getState().isOpen ? r4.getState().collections.map(function(e5) {
        var n4 = e5.source;
        return jn(t3.id, "list", n4);
      }).join(" ") : void 0, "aria-labelledby": jn(t3.id, "label"), value: r4.getState().completion || r4.getState().query, id: jn(t3.id, "input"), autoComplete: "off", autoCorrect: "off", autoCapitalize: "off", enterKeyHint: m2, spellCheck: "false", autoFocus: t3.autoFocus, placeholder: t3.placeholder, maxLength: l3, type: "search", onChange: function(e5) {
        var i4 = e5.currentTarget.value;
        t3.ignoreCompositionEvents && In(e5).isComposing ? o3.setQuery(i4) : ur(Or({ event: e5, props: t3, query: i4.slice(0, l3), refresh: n3, store: r4 }, o3));
      }, onCompositionEnd: function(e5) {
        ur(Or({ event: e5, props: t3, query: e5.currentTarget.value.slice(0, l3), refresh: n3, store: r4 }, o3));
      }, onKeyDown: function(e5) {
        In(e5).isComposing || function(e6) {
          var t4 = e6.event, n4 = e6.props, r5 = e6.refresh, o4 = e6.store, i4 = function(e7, t5) {
            if (null == e7)
              return {};
            var n5, r6, o5 = function(e8, t6) {
              if (null == e8)
                return {};
              var n6, r7, o6 = {}, i6 = Object.keys(e8);
              for (r7 = 0; r7 < i6.length; r7++)
                n6 = i6[r7], t6.indexOf(n6) >= 0 || (o6[n6] = e8[n6]);
              return o6;
            }(e7, t5);
            if (Object.getOwnPropertySymbols) {
              var i5 = Object.getOwnPropertySymbols(e7);
              for (r6 = 0; r6 < i5.length; r6++)
                n5 = i5[r6], t5.indexOf(n5) >= 0 || Object.prototype.propertyIsEnumerable.call(e7, n5) && (o5[n5] = e7[n5]);
            }
            return o5;
          }(e6, sr);
          if ("ArrowUp" === t4.key || "ArrowDown" === t4.key) {
            var a4 = function() {
              ...
              if (null !== o4.getState().activeItemId && e7) {
                ...
                u5.onActive(pr({ event: t4, item: n5, itemInputValue: a5, itemUrl: c5, refresh: r5, source: u5, state: o4.getState() }, i4));
              }
            };
            t4.preventDefault(), false === o4.getState().isOpen && (n4.openOnFocus || Boolean(o4.getState().query)) ? ur(pr({ event: t4, props: n4, query: o4.getState().query, refresh: r5, store: o4 }, i4)).then(function() {
            ...
            if (t4.metaKey || t4.ctrlKey)
              void 0 !== f3 && (p3.onSelect(pr({ event: t4, item: l4, itemInputValue: s3, itemUrl: f3, refresh: r5, source: p3, state: o4.getState() }, i4)), n4.navigator.navigateNewTab({ itemUrl: f3, item: l4, state: o4.getState() }));
            else if (t4.shiftKey)
              void 0 !== f3 && (p3.onSelect(pr({ event: t4, item: l4, itemInputValue: s3, itemUrl: f3, refresh: r5, source: p3, state: o4.getState() }, i4)), n4.navigator.navigateNewWindow({ itemUrl: f3, item: l4, state: o4.getState() }));
            else if (t4.altKey)
              ;
            else {
              if (void 0 !== f3)
                return p3.onSelect(pr({ event: t4, item: l4, itemInputValue: s3, itemUrl: f3, refresh: r5, source: p3, state: o4.getState() }, i4)), void n4.navigator.navigate({ itemUrl: f3, item: l4, state: o4.getState() });
              ur(pr({ event: t4, nextState: { isOpen: false }, props: n4, query: s3, refresh: r5, store: o4 }, i4)).then(function() {
                p3.onSelect(pr({ event: t4, item: l4, itemInputValue: s3, itemUrl: f3, refresh: r5, source: p3, state: o4.getState() }, i4));
              });
            }
          }
        }(Or({ event: e5, props: t3, refresh: n3, store: r4 }, o3));
      }, onFocus: a3, onBlur: Ft, onClick: function(n4) {
        e4.inputElement !== t3.environment.document.activeElement || r4.getState().isOpen || a3(n4);
      } }, s2);
    }, getPanelProps: function(e4) {
      return Or({ onMouseDown: function(e5) {
        e5.preventDefault();
      }, onMouseLeave: function() {
        r4.dispatch("mouseleave", null);
      } }, e4);
    }, getListProps: function(e4) {
      var n4 = e4 || {}, r5 = n4.source, o4 = Er(n4, gr);
      return Or({ role: "listbox", "aria-labelledby": jn(t3.id, "label"), id: jn(t3.id, "list", r5) }, o4);
    }, getItemProps: function(e4) {
      var i3 = e4.item, a3 = e4.source, c3 = Er(e4, br);
      return Or({ id: jn(t3.id, "item-".concat(i3.__autocomplete_id), a3), role: "option", "aria-selected": r4.getState().activeItemId === i3.__autocomplete_id, onMouseMove: function(e5) {
        if (i3.__autocomplete_id !== r4.getState().activeItemId) {
          r4.dispatch("mousemove", i3.__autocomplete_id);
          var t4 = En(r4.getState());
          if (null !== r4.getState().activeItemId && t4) {
            var a4 = t4.item, c4 = t4.itemInputValue, u3 = t4.itemUrl, l3 = t4.source;
            l3.onActive(Or({ event: e5, item: a4, itemInputValue: c4, itemUrl: u3, refresh: n3, source: l3, state: r4.getState() }, o3));
          }
        }
      }, onMouseDown: function(e5) {
        e5.preventDefault();
      }, onClick: function(e5) {
        var c4 = a3.getItemInputValue({ item: i3, state: r4.getState() }), u3 = a3.getItemUrl({ item: i3, state: r4.getState() });
        (u3 ? Promise.resolve() : ur(Or({ event: e5, nextState: { isOpen: false }, props: t3, query: c4, refresh: n3, store: r4 }, o3))).then(function() {
          a3.onSelect(Or({ event: e5, item: i3, itemInputValue: c4, itemUrl: u3, refresh: n3, source: a3, state: r4.getState() }, o3));
        });
      } }, c3);
    } };
  ...
  function c2(e3) {
    e3.forEach(function(e4) {
      var r4;
      return null === (r4 = e4.subscribe) || void 0 === r4 ? void 0 : r4.call(e4, Mr(Mr({}, o2), {}, { navigator: n2.navigator, refresh: a2, onSelect: function(e5) {
        t2.push({ onSelect: e5 });
  ...
  return c2(n2.plugins), function(e3) {
    var t3, n3, r4 = e3.metadata, o3 = e3.environment;
    if (null === (t3 = o3.navigator) || void 0 === t3 || null === (n3 = t3.userAgent) || void 0 === n3 ? void 0 : n3.includes("Algolia Crawler")) {
      ...
      i3.name = "algolia:metadata", setTimeout(function() {
        i3.content = JSON.stringify(r4), a3.appendChild(i3);
      }, 0);
    }
...
function Io(e2) {
  ...
  return { get: function(t3, n3) {
    ...
    return Promise.resolve().then(function() {
      var n4, r5, a2;
      return n4 = e2.timeToLive ? 1e3 * e2.timeToLive : null, r5 = o2(), i2(a2 = Object.fromEntries(Object.entries(r5).filter(function(e3) {
        return void 0 !== jt(e3, 2)[1].timestamp;
      }))), n4 && i2(Object.fromEntries(Object.entries(a2).filter(function(e3) {
        var t4 = jt(e3, 2)[1], r6 = (/* @__PURE__ */ new Date()).getTime();
        return !(t4.timestamp + n4 < r6);
      }))), o2()[JSON.stringify(t3)];
    }).then(function(e3) {
      return Promise.all([e3 ? e3.value : n3(), void 0 !== e3]);
    }).then(function(e3) {
      var t4 = jt(e3, 2), n4 = t4[0], o3 = t4[1];
      return Promise.all([n4, o3 || r4.miss(n4)]);
    }).then(function(e3) {
      return jt(e3, 1)[0];
    });
  }, set: function(e3, t3) {
...
function Yo(e2) {
  var t2 = e2.appId, n2 = e2.apiKey, r2 = e2.indexName, o2 = e2.placeholder, i2 = void 0 === o2 ? "Search docs" : o2, a2 = e2.searchParameters, c2 = e2.maxResultsPerGroup, u2 = e2.onClose, l2 = void 0 === u2 ? mo : u2, s2 = e2.transformItems, f2 = void 0 === s2 ? fo : s2, p2 = e2.hitComponent, m2 = void 0 === p2 ? Kr : p2, v2 = e2.resultsFooterComponent, h2 = void 0 === v2 ? function() {
    ...
    return ut.useMemo(function() {
      var r4 = function(e4, t4) {
        ...
        return function(e5) {
          var t5 = e5.appId, n4 = e5.apiKey, r5 = e5.authMode, o3 = e5.algoliaAgents, i3 = Ot(e5, zo), a3 = function(e6, t6) {
            var n5 = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "WithinHeaders", r6 = { "x-algolia-api-key": t6, "x-algolia-application-id": e6 };
            return { headers: function() {
              return "WithinHeaders" === n5 ? r6 : {};
            }, queryParameters: function() {
              return "WithinQueryParameters" === n5 ? r6 : {};
            } };
          }(t5, n4, r5), c3 = function(e6) {
            var t6 = e6.hosts, n5 = e6.hostsCache, r6 = e6.baseHeaders, o4 = e6.logger, i4 = e6.baseQueryParameters, a4 = e6.algoliaAgent, c4 = e6.timeouts, u3 = e6.requester, l3 = e6.requestsCache, s3 = e6.responsesCache;
            function f3(e7) {
                ...
                return wt().wrap(function(e8) {
                  for (; ; )
                    switch (e8.prev = e8.next) {
                      ...
                      case 2:
                        return r7 = e8.sent, o5 = r7.filter(function(e9) {
                          return e9.isUp();
                        }), i5 = r7.filter(function(e9) {
              ...
              return v3 = ft(wt().mark(function e7(l4, s4) {
                ...
                return wt().wrap(function(e8) {
                  for (; ; )
                    switch (e8.prev = e8.next) {
                      case 0:
                        if (p4 = !(j3.length > 2 && void 0 !== j3[2]) || j3[2], m4 = [], v4 = Uo(l4, s4), h3 = Fo(r6, l4.headers, s4.headers), d3 = "GET" === l4.method ? St(St({}, l4.data), s4.data) : {}, y3 = St(St(St({}, i4), l4.queryParameters), d3), a4.value && (y3["x-algolia-agent"] = a4.value), s4 && s4.queryParameters)
                        ...
                        return S3 = 0, O3 = function() {
                          var e9 = ft(wt().mark(function e10(t7, r7) {
                              ...
                              for (; ; )
                                switch (e11.prev = e11.next) {
                                  case 0:
                                    ...
                                    throw new Ro(Ko(m4));
                                  case 3:
                                    return a5 = St(St({}, c4), s4.timeouts), f4 = { data: v4, headers: h3, method: l4.method, url: Ho(i5, l4.path, y3), connectTimeout: r7(S3, a5.connect), responseTimeout: r7(S3, p4 ? a5.read : a5.write) }, d4 = function(e12) {
                                  ...
                                  case 15:
                                    return e11.abrupt("return", O3(t7, r7));
                                  case 16:
                                    if (2 != ~~(_4.status / 100)) {
                                      e11.next = 18;
                                      break;
            ...
            return { hostsCache: n5, requester: u3, timeouts: c4, logger: o4, algoliaAgent: a4, baseHeaders: r6, baseQueryParameters: i4, hosts: t6, request: function(e7) {
              ...
              if (true !== (t7.cacheable || e7.cacheable))
                return o5();
              var a5 = { request: e7, requestOptions: t7, transporter: { queryParameters: i4, headers: r6 } };
          ...
          return { transporter: c3, appId: t5, clearCache: function() {
            ...
            var t6 = e6.apiKey;
            r5 && "WithinHeaders" !== r5 ? c3.baseQueryParameters["x-algolia-api-key"] = t6 : c3.baseHeaders["x-algolia-api-key"] = t6;
          }, searchForHits: function(e6, t6) {
            return this.search(e6, t6);
          }, searchForFacets: function(e6, t6) {
            return this.search(e6, t6);
          }, customPost: function(e6, t6) {
            var n5 = e6.path, r6 = e6.parameters, o4 = e6.body;
            if (!n5)
              throw new Error("Parameter `path` is required when calling `customPost`.");
            var i4 = { method: "POST", path: "/{path}".replace("{path}", n5), queryParameters: r6 || {}, headers: {}, data: o4 || {} };
            ...
            var r6 = { method: "POST", path: "/1/indexes/*/queries", queryParameters: {}, headers: {}, data: e6, useReadTransporter: true, cacheable: true };
            return c3.request(r6, t6);
          } };
          ...
          return new Promise(function(t5) {
            ...
            var r5, o3 = function(e6, r6) {
              return setTimeout(function() {
                n4.abort(), t5({ status: 0, content: r6, isTimedOut: true });
              }, e6);
            }, i3 = o3(e5.connectTimeout, "Connection timeout");
            n4.onreadystatechange = function() {
              n4.readyState > n4.OPENED && void 0 === r5 && (clearTimeout(i3), r5 = o3(e5.responseTimeout, "Socket timeout"));
            }, n4.onerror = function() {
              0 === n4.status && (clearTimeout(i3), clearTimeout(r5), t5({ content: n4.responseText || "Network request failed", status: n4.status, isTimedOut: false }));
            }, n4.onload = function() {
              clearTimeout(i3), clearTimeout(r5), t5({ content: n4.responseText, status: n4.status, isTimedOut: false });
            }, n4.send(e5.data);
          });
      ...
      return r4.addAlgoliaAgent("docsearch", Zo), false === /docsearch.js \(.*\)/.test(r4.transporter.algoliaAgent.value) && r4.addAlgoliaAgent("docsearch-react", Zo), n3(r4);
    }, [e3, t3, n3]);
          ...
          return { sourceId: "hits".concat(t3), onSelect: function(e6) {
            ...
            return Object.values(so(e5, function(e6) {
              ...
              return e6.map(function(t4) {
                var n3 = null, r4 = e6.find(function(e7) {
                  return "lvl1" === e7.type && e7.hierarchy.lvl1 === t4.hierarchy.lvl1;
                });
                return "lvl1" !== t4.type && r4 && (n3 = r4), St(St({}, t4), {}, { __docsearch_parent: n3 }, v3);
              });
            }).flat();
          } };
        });
  ...
  return function(e3) {
    var t3 = e3.getEnvironmentProps, n3 = e3.panelElement, r4 = e3.formElement, o3 = e3.inputElement;
    ut.useEffect(function() {
      if (n3 && r4 && o3) {
        var e4 = t3({ panelElement: n3, formElement: r4, inputElement: o3 }), i3 = e4.onTouchStart, a3 = e4.onTouchMove;
    ...
    ut.useEffect(function() {
      if (t3) {
        var e4 = t3.querySelectorAll("a[href]:not([disabled]), button:not([disabled]), input:not([disabled])"), n3 = e4[0], r4 = e4[e4.length - 1];
        return t3.addEventListener("keydown", o3), function() {
          t3.removeEventListener("keydown", o3);
        };
      }
      function o3(e5) {
        "Tab" === e5.key && (e5.shiftKey ? document.activeElement === n3 && (e5.preventDefault(), r4.focus()) : document.activeElement === r4 && (e5.preventDefault(), n3.focus()));
      }
    }, [t3]);
...
function Xo(e2) {
  ...
  return function(e3) {
    var t3 = e3.isOpen, n3 = e3.onOpen, r4 = e3.onClose, o3 = e3.onInput, i3 = e3.searchButtonRef;
    ut.useEffect(function() {
      function e4(e5) {
        var a3;
        if ("Escape" === e5.code && t3 || "k" === (null === (a3 = e5.key) || void 0 === a3 ? void 0 : a3.toLowerCase()) && (e5.metaKey || e5.ctrlKey) || !function(e6) {
          ...
          return e5.preventDefault(), void (t3 ? r4() : document.body.classList.contains("DocSearch--active") || n3());
