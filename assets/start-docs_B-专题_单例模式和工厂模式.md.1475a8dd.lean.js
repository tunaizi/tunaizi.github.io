import{_ as s,r as e,i as a,a as l}from"./chunks/framework.15d2e201.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"单例模式","slug":"单例模式","link":"#单例模式","children":[]},{"level":2,"title":"工厂模式","slug":"工厂模式","link":"#工厂模式","children":[]}],"relativePath":"start-docs/B-专题/单例模式和工厂模式.md","filePath":"start-docs/B-专题/单例模式和工厂模式.md"}'),p={name:"start-docs/B-专题/单例模式和工厂模式.md"};function c(t,n,o,i,r,y){return e(),a("div",null,n[0]||(n[0]=[l(`<h2 id="单例模式" tabindex="-1">单例模式 <a class="header-anchor" href="#单例模式" aria-label="Permalink to &quot;单例模式&quot;">​</a></h2><ul><li>类只有一个实例</li><li>可以绑定在全局实例，也可以通过闭包来私有变量，还可以通过es6的symbol</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark"><code><span class="line"><span style="color:#e1e4e8;">var Singleton = function(name) {</span></span>
