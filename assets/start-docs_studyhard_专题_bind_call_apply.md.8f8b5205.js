import{_ as n,r as a,i as l,a as p}from"./chunks/framework.8a6edf47.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"bind & call & apply","slug":"bind-call-apply","link":"#bind-call-apply","children":[]}],"relativePath":"start-docs/studyhard/专题/bind&call&apply.md","filePath":"start-docs/studyhard/专题/bind&call&apply.md"}'),o={name:"start-docs/studyhard/专题/bind&call&apply.md"};function e(c,s,t,r,E,y){return a(),l("div",null,s[0]||(s[0]=[p(`<h2 id="bind-call-apply" tabindex="-1">bind &amp; call &amp; apply <a class="header-anchor" href="#bind-call-apply" aria-label="Permalink to &quot;bind &amp; call &amp; apply&quot;">​</a></h2><ul><li>call 和 apply,是为了动态改变 this 而出现。当一个 object 没有某个方法，但是其他对象有，就可以借助 call 和 apply 来使用其他对象的方法。</li></ul><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#6A737D;">// document.getElementsByTagName选择的dom 节点是一种类似array的array。它不能应用Array下的push,pop等方法</span></span>
